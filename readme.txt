Riz Cleaner - Limpiador de Archivos Temporales de Windows
=========================================================

Descripción:
-------------
Riz Cleaner es un script de Windows diseñado para eliminar archivos temporales y limpiar tu sistema de forma rápida y sencilla.
...
4. Crear el "ejecutable" accesible:
   - Haz clic derecho sobre `Riz Cleaner.bat` y selecciona "Crear acceso directo".
   - Mueve el acceso directo al escritorio para tenerlo a mano.

5. Cambiar el icono del acceso directo:
   - Haz clic derecho sobre el acceso directo > Propiedades > Cambiar icono...
   - Selecciona el archivo `Riz Cleaner.ico` que se encuentra en la carpeta del script.
